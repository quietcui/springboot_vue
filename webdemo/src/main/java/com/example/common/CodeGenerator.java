...
// 全局配置
        ...
        String projectPath = System.getProperty("user.dir")+"/webdemo";
...
// ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/backengine?useUnicode=true&characterEncoding=UTF8&useSSL=false");
// dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("cui520131");
...
// ⾃定义输出⽂件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发⽣化！！
